...
console.log("Gmail Configuration:", process.env.GMAIL_USER ? "Email configured" : "Email not configured");
      ...
      const mailOptions = {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e9e9e9; border-radius: 5px;">
            <h2 style="color: #333; text-align: center;">WORKFLOW<span style="color: #eab308;">X.</span> Password Reset</h2>
            <p>Hello,</p>
